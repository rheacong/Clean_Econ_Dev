...
policy_radial<-ggplot(xchange %>% filter(region %in% states_simple$region,
                                         Topic != "total_climate") %>%
...
write.csv(gjf_stateagency, file = paste0(output_folder, state_abbreviation, "_gjf_stateagency", ".csv"))
...
write.csv(gjf_stateprogram_1923, file = paste0(output_folder, state_abbreviation, "_gjf_stateprogram", ".csv"))
...
write.csv(gjf_meaningful_1923, file = paste0(output_folder, state_abbreviation, "_gjf_meaningful", ".csv"))
